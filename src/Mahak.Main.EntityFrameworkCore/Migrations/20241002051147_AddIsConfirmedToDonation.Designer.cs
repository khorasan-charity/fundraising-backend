...
namespace Mahak.Main.Migrations
{
    ...
    [Migration("20241002051147_AddIsConfirmedToDonation")]
    partial class AddIsConfirmedToDonation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Mahak.Main.Attributes.Attribute", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Mahak.Main.Campaigns.Campaign", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Mahak.Main.Campaigns.CampaignItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("AppCampaignItems", (string)null);
                });

            modelBuilder.Entity("Mahak.Main.Campaigns.CampaignItemAttribute", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("AppCampaignItemAttributes", (string)null);
                });

            modelBuilder.Entity("Mahak.Main.Donations.Donation", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Mahak.Main.Campaigns.CampaignItem", b =>
                {
                    b.HasOne("Mahak.Main.Campaigns.Campaign", "Campaign")
            ...
            modelBuilder.Entity("Mahak.Main.Campaigns.CampaignItemAttribute", b =>
                {
                    b.HasOne("Mahak.Main.Attributes.Attribute", "Attribute")
                        .WithMany()
                        .HasForeignKey("AttributeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Mahak.Main.Campaigns.CampaignItem", "CampaignItem")
                        .WithMany("Attributes")
