        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ThumbnailImageFileId = table.Column<Guid>(type: "uuid", nullable: true),
                    ...
                    RaiseCount = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppCampaignItems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppCampaignItems_AppCampaigns_CampaignId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AppTransactions_AppPayments_PaymentId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CampaignId = table.Column<int>(type: "integer", nullable: false),
                    Type = table.Column<int>(type: "integer", nullable: false),
                    CampaignItemId = table.Column<int>(type: "integer", nullable: true),
                    Amount = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AppDonations_AppCampaignItems_CampaignItemId",
                        column: x => x.CampaignItemId,
                        principalTable: "AppCampaignItems",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_AppDonations_AppCampaigns_CampaignId",
                        column: x => x.CampaignId,
                        principalTable: "AppCampaigns",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AppDonations_AppPayments_PaymentId",
                        column: x => x.PaymentId,
                        principalTable: "AppPayments",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppCampaignItems_CampaignId",
                table: "AppCampaignItems",
                column: "CampaignId");

            migrationBuilder.CreateIndex(
                name: "IX_AppDonations_CampaignId",
                table: "AppDonations",
                column: "CampaignId");

            migrationBuilder.CreateIndex(
                name: "IX_AppDonations_CampaignItemId",
                table: "AppDonations",
                column: "CampaignItemId");

            migrationBuilder.CreateIndex(
                name: "IX_AppDonations_PaymentId",
                table: "AppDonations",
                column: "PaymentId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppPayments_TrackingNumber",
                table: "AppPayments",
                column: "TrackingNumber",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_AppTransactions_PaymentId",
